...
/*Registration*/
function register(){
    let firstNane = document.getElementById("signup-name").value;
    let lastName = document.getElementById("signup-surname").value;
    ...
    $.ajax({
        url: 'http://localhost:8091/api/v1/griever/register-griever',
        type: 'POST',
        dataType: "json",
        crossDomain: "true",
        ...
        if (response.status == 500){
            ...
            document.getElementById("error-text").innerText = "Registration failed"
        }
        document.getElementById("error-text").classList.remove("d-none")
    })
}

/*Virtual assistant open chat*/
function openAIChat(){
    let html = `<div class="container h-100">
                    ...
                    <br><br><br><br><br>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
                </div>`
...
function optionOne(e) {
    // e.preventDefault();
    let option = document.getElementById("message-box").value
    let messageContainer = document.getElementById("message-container");

    let message = document.createElement("div");

    if (option !== null && option < 3 && option > 0 ){
        let messageHtml = `
        <div class="message message-out">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-profile" class="avatar avatar-responsive">
                                    <img class="avatar-img" src="assets/img/avatars/1.jpg" alt="">
        ...
        if (option == 1){
            document.getElementById("btn-send").removeAttribute("onclick")
            // document.getElementById("btn-send").setAttribute("onclick", "scanQRCode()")
            scanQRCode();
        }else{
            enterLicencePlate();
        }
    }else {
        return alert("please type in a valid option")
    }
}
...
function scanQRCode(){
    ...
    /*typing message*/
    let typingMessage = `<div class="message" id="typing-message">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-user-profile" class="avatar avatar-responsive">
                                    <img class="avatar-img" src="assets/img/avatars/2.jpg" alt="">
                                </a>
                                ...
                                <div class="message-inner">
                                    <div class="message-body">
                                        <div class="message-content">
                                            <div class="message-text">
                                                <p>Madara is typing<span class='typing-dots'><span>.</span><span>.</span><span>.</span></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    message.innerHTML = typingMessage
    ...
    setTimeout(() => {
        ...
        let aiMessage = `<div class="message">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-user-profile" class="avatar avatar-responsive">
                                    <img class="avatar-img" src="assets/img/avatars/2.jpg" alt="">
                                </a>
                                ...
                                <div class="message-inner">
                                    <div class="message-body">
                                        <div class="message-content">
                                            <div class="message-text">
                                                <p>I am going to open your camera to scan the QR code, <br> Please click allow on the notification popup on your device</p>
                                            </div>
                                        ...
                                        <div class="message-content">
                                            <div class="message-text">
                                                <p><video class="fe-video"  id="preview"></video></p>
                                            </div>
        ...
        scanner.addListener('scan', function (content) {
            ...
            $.ajax({
                url: 'http://localhost:8094/api/v1/vehicle/get-vehicle/'+1,
                type: 'POST',
                dataType: "json",
                crossDomain: "true",
                contentType: "application/json; charset=utf-8",
